...
class DS3231:
    def __init__(self, i2c):
        ...
        if _ADDR not in self.ds3231.scan():
            raise RuntimeError(
                "DS3231 not found on I2C bus at  %d" % _ADDR)

    def get_time(self, data=bytearray(7), set_rtc=False):
